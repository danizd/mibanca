...
class MovimientosTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::getTableLocator()->exists('Movimientos') ? [] : ['className' => MovimientosTable::class];
        $this->Movimientos = TableRegistry::getTableLocator()->get('Movimientos', $config);
    }
